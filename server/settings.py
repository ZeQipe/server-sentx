...
# Google One Tap Settings (uses same credentials as OAuth2)
GOOGLE_CLIENT_ID = os.environ.get("GOOGLE_CLIENT_ID", SOCIAL_AUTH_GOOGLE_OAUTH2_KEY)
GOOGLE_CLIENT_SECRET = os.environ.get("GOOGLE_CLIENT_SECRET", SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET)
